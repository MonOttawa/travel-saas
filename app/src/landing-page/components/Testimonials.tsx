...
export default function Testimonials({ testimonials }: { testimonials: Testimonial[] }) {
  ...
  return (
    <div className='mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8'>
      <SectionTitle
        title='Trusted by finance and travel leaders'
        description='Organisations across Canada use Travel Cost Estimator to approve trips faster and stay audit-ready.'
      />
          ...
          <div key={idx} className='break-inside-avoid mb-6'>
            <Card className='flex flex-col justify-between'>
              <CardContent className='p-6'>
                <blockquote className='leading-7 sm:leading-8 mb-4'>
                  <p className='italic text-base sm:text-lg text-foreground/90'>{testimonial.quote}</p>
                </blockquote>
              </CardContent>
              <CardFooter className='pt-0 flex flex-col'>
                ...
                >
                  ...
                  <div className='min-w-0 flex-1'>
                    <CardTitle className='text-sm font-semibold tracking-tight group-hover:text-card-foreground transition-colors duration-200 truncate'>
                      {testimonial.name}
                    </CardTitle>
