...
const ExamplesCarousel = ({ examples }: { examples: ExampleApp[] }) => {
  ...
  return (
    ...
    >
      <h2 className='mb-2 text-center text-sm font-semibold uppercase tracking-[0.3em] text-primary'>Trusted by teams</h2>
      <p className='mb-6 text-center text-muted-foreground text-base max-w-2xl sm:text-lg'>
        Travel coordinators, finance leads, and procurement specialists across Canada rely on our estimates to stay
